...
const bookDate = document.getElementById('bookDate') as HTMLInputElement || null;
const startTime = document.getElementById('startTime') as HTMLInputElement || null;
const endTime = document.getElementById('endTime') as HTMLInputElement || null;
const bookingTitle = document.getElementById('title') as HTMLInputElement || null;
const bookingDesc = document.getElementById('desc') as HTMLInputElement || null;
const resetBooking = document.getElementById('resetBooking') as HTMLButtonElement || null;
...
function addBookingEventListners() {
    const btnEdit = document.querySelectorAll<HTMLButtonElement>(".edit-booking");
    btnEdit.forEach(btn => {
    ...
    const btnDelete = document.querySelectorAll<HTMLButtonElement>(".delete-booking");

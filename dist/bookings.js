...
bookingForm.addEventListener("submit", (e) => {
    ...
    if (bookingEditId === null) {
        addNewBooking({ roomId: Number(roomId), date, startTime: s_Time, endTime: e_Time, title, description: desc, id: nextBookingId++ });
    }
    else {
        ...
        saveBooking(bookingEditId, { roomId: Number(roomId), date, startTime: s_Time, endTime: e_Time, title, description: desc, id: bookingEditId });
    }
});
// Reset booking form
